...
class TestCase(abc.ABC):
    ...
    @staticmethod
    def use_perf_client() -> bool:
        return False

    @staticmethod
    def use_perf_server() -> bool:
        return False
...
class MeasurementPerfClient(MeasurementGoodput):
    ...
    @staticmethod
    def desc():
        return "Measures connection goodput as baseline with perf running on the client."
...
class MeasurementPerfServer(MeasurementGoodput):
    ...
    @staticmethod
    def desc():
        return "Measures connection goodput as baseline with perf running on the server."
...
class MeasurementPerfBoth(MeasurementGoodput):
    ...
    @staticmethod
    def desc():
        return "Measures connection goodput as baseline with perf running on client and server."
...
class MeasurementOptimize(Measurement):
    FILESIZE = 200 * MB
    _result = 0.0
